/**
 * Money tab — placeholder UI for the v0 "early access beta" rollout.
 *
 * Visibility rules (enforced both here AND in Layout's navItems):
 *   - Premium users on iOS or web: SEE the tab
 *   - Non-Premium users: tab hidden + page redirects
 *   - Android TWA users: tab hidden (Google Play payment policy; same
 *     rule we apply to every premium feature until v2 ships Play Billing)
 *
 * This file ships in 1.2.9 / 1.3.0 as a "Coming Soon — Beta" placeholder.
 * Premium users see the roadmap + opt-in for "notify when ready."
 *
 * Replaced incrementally:
 *   Week 2: replace this with InsightsHome.tsx (bank connection UI)
...
import { Wallet, Sparkles, CheckCircle2, Circle, Loader2 } from "lucide-react";
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="rounded-2xl border border-border bg-card/30 p-5 text-center">
        <h3 className="text-sm font-semibold mb-2">Will I have to wait long?</h3>
